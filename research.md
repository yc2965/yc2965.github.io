...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img
    src="/images/velocity-log-law.jpg"
    alt="Comparison between MOST and the stratification-dependent log law"
    style="width: 100%; max-width: 750px;"
  >
</figure>
...
**AGU EOS research spotlight**: [Seemingly Simple Climate Adaptation Strategy Could Backfire](https://eos.org/research-spotlights/seemingly-simple-climate-adaptation-strategy-could-backfire)
...
## 4) Identification of key land-atmosphere processes controlling climate extremes
